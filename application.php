...
// add_post_type('case', 'Projektsida', array('public' => true, 'taxonomies'  => array( 'category' ),'supports' => array('title', 'thumbnail')));
...
if(function_exists('acf_add_options_sub_page')){
 acf_add_options_sub_page(array(
   'page_title' => 'Sidfot inställning',
   'menu_title' => 'Sidfot inställning',
